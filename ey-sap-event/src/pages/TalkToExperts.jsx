...
export default function TalkToExperts() {
  const experts = [
    ...
    {
      name: "Abhinav Johri ",
      role: "Partner/Principal at EY | EMEIA Digital Engineering & AI Consulting | Adjunct Faculty",
    ...
    },
    {
      ...
      role: "Partner and SAP Leader for EY India",
    ...
    {
      name: "Udit Aggarwal",
      role: "Alliance and Ecosystem leader for EY India & Africa Region AND Consulting Leader, EY India Market Segment for Technology, M&E, Telecom and GCCs (non FS)",
